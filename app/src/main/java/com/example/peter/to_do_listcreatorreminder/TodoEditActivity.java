...
import com.example.peter.to_do_listcreatorreminder.util.AlarmUtils;
import com.example.peter.to_do_listcreatorreminder.util.DateUtils;
import com.example.peter.to_do_listcreatorreminder.util.UIUtils;
...
public class TodoEditActivity extends AppCompatActivity implements
    ...
    private void setupUI(){
        ...
        todoEdit = (EditText) findViewById(R.id.todo_detail_edit);
